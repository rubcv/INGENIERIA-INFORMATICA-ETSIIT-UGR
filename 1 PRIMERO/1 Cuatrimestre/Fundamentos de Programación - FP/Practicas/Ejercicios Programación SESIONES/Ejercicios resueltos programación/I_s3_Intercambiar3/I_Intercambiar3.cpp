...
int main()
{
   ...
   /*	
   //	Primera forma (Orden de ejecución de las asignaciones: de derecha a izda)
   //	 y <- x <- z <- y
   //            ------
   //       ------
   //  -------
   ...
   */
   ...
   //	Segunda forma (Orden de ejecución de las asignaciones: de izda a derecha)
   //	 y <- x <- z <- y
   //  -------
   //       -------
   //            -------
   ...
   // Mucho más fácil de entender y generalizable a varias variables
   // Moraleja: No implementad la primera solución que se nos ocurra.
