...
/**
 * @brief Una imagen en blanco y negro. Cada pixel es un byte
 *
 */
 ...
 * como un vector, la posicion (@a x,@a y) corresponde a la posición @a y * @c ncolumnas + @a x 
 * del vector.    
 */
...
/**
 * @brief Dado un número k, extrae el plano de bits k-esimo de la imagen actual y lo devuelva como una nueva imagen
 ...
 * @retval true Si ha tenido exito en la conversion
 * @retval false Si se ha producido algun error en la conversion
 * 
 */
