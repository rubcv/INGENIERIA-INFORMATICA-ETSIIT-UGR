...
int main(int argc, char *argv[]){
    ...
    const char* nombreArchivo = "clinvar_20160831.vcf"; // El archivo se guarda en datos (En el mismo directorio que el programa)

    cout<< "Abriendo el archivo " << nombreArchivo << endl << endl;
    //Cargar las mutaciones en clinvar
    mutacion una;
    una = clinvar.load(nombreArchivo);
    ...
    foo = clinvar.topKMutaciones(5, "basal");
