...
class ClinVar{
  ...
  public:
    ...
    *
    */
    struct ProbMutaciones{ // Orden decreciente
      bool operator()(const mutacion &m1, const mutacion &m2){
        return (m1.getCaf()[0] > m2.getCaf()[0]);       // A menor valor, más probable
      }
    };
    ...
    */
    ...
    void Reinsertar(mutacion una, priority_queue<mutacion, vector<mutacion>, ClinVar::ProbMutaciones> &cola);
