...
class Estanco extends AbstractMonitor{
  ...
  private int anterior1, anterior2; // Para contar las veces que aparece cada ingrediente
// ---------------------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------------------
  ...
  public void obtenerIngrediente(int miIngrediente){
    enter();
      boolean puede = false;
      if(miIngrediente == anterior1){
        System.out.println("FUMADOR: Es la segunda vez que voy a por el ingrediente " + ingredienteDepositado + ", puedo fumar");
        puede = true;
      }
      if(puede){
...
// ---------------------------------------------------------------------------------------
  ...
  public void ponerIngrediente(int ingrediente){
    enter();
      if(ingrediente == anterior2){
        System.out.println("ESTANQUERO: Puesto dos veces el mismo ingrediente");
      }
