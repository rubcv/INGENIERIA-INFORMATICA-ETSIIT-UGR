...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2018 a las 14:04:41
...
('imagenes_subidas/articulos/snoop1.jpg', 'Discos (Ed. Especial)', '35', 'merch'),
('imagenes_subidas/articulos/snoop3.jpg', 'Doggystyle (Special Ed.)', '25', 'disco'),
('imagenes_subidas/articulos/last-meal.jpg', 'Last Meal', '16', 'disco'),
('imagenes_subidas/articulos/snoop2.jpg', 'Merchandising', '25', 'merch'),
('imagenes_subidas/articulos/neva-left.jpg', 'Neva Left', '11', 'disco');
...
('Doggystyle (Ed. Especial)', 'Still DRE', '3:26');
...
('Snoop Doggy Dogg', '2018-03-09', 'imagenes_subidas/componentes/snoop4.jpg', 'Primero en el tema principal del largometraje Deep Cover, y despuÃ©s con criss monstar en el Ã¡lbum debut en solitario de Dr. Dre, The Chronic, junto con otros miembros de su antiguo grupo, Tha Dogg Pound. La contribuciÃ³n de Snoop en The Chronic fue considerable; su presencia en el disco es notable y preparaba el terreno para su lanzamiento en solitario. \r\n                ');
...
('imagenes_subidas/conciertos/poster.jpg', '2018-08-18', '17:30', 'Madrid', 'Madrid Arena', ' Impresionante escenario planeado para el concierto de Snoop Dogg en Madrid en el Madrid Arena el prÃ³ximo 18/08/2018 a las 17:30\r\n                '),
...
('imagenes_subidas/discos/snoop3.jpg', 'Doggystyle (Ed. Especial)', 2018),
...
('Nuevo', 'Admin', 123123123, 'nuevo@gmail.com2', 'MTIzNA=='),
('Armando ', 'Casas', 123456789, 'prueb1a@gmail.com', 'MTIzNA=='),
('Batman', 'Superman', 123456789, 'prueba@gmail.com', 'MTIzNA==');
...
('prueba@gmail.com', '2018-06-08', '2008-06-18', 'Armando ', 'Casas', 'aceptado', 'Sisisi espero que te guste', '||Doggystyle || ', 3),
('prueba@gmail.com', '2018-06-08', '2008-06-18', 'Armando ', 'Casas', 'denegado', 'Lo siento pero no quedan existencias', '||Doggystyle || ', 4),
('prueba@gmail.com', '2018-06-08', '2008-06-18', 'Armando ', 'Casas', 'denegado', 'Sin existencias', '||NevaLeft || ', 5),
('snoop@gmail.com', '2018-06-10', '2010-06-18', 'Armando ', 'Casas', 'aceptado', 'Enhorabuena, le enviaremos su pedido', '||Discos (Ed. Especial) || Last Meal || Merchandis', 6);
...
('nuevo@gmail.com2', 'MTIzNA==', 'gestor'),
