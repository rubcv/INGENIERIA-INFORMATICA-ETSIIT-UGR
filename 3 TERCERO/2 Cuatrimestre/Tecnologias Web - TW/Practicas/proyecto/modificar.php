	...
	<body>
		...
		<section id="cabecera" class="centrado">
            ...
            <?php
                ...
                // modificar.php recibe los formularios sobre modificar cualquier campo que se cargan con formularios_gestion.php
                // Para mas info ver gestion.php (IMPORTANTE) y formularios_gestion.php
                ...
                if($_SESSION['tipo'] == 'admin'){
                    ...
                    isset($_POST['precio_articulo_modificado'])){
                        ...
                        if(preg_match('/\d/', $_POST['nombre_articulo_modificado']) || !preg_match('/[0-9]/', $_POST['precio_articulo_modificado'])){
                            ...
                            $nuevo_nombre = $mysqli->real_escape_string($_POST['nombre_articulo_modificado']);
                            $nuevo_precio = $mysqli->real_escape_string($_POST['precio_articulo_modificado']);
                    ...
                    isset($_POST['año_mod'])){
                        ...
                        // Mostramos un formulario para añadir canciones
                        ...
                        ';
                        // Segun el numero introducido en ese formulario, al hacer click en añadir hacemos append html 
                        // con el respectivo numero de inputs 
                        echo '<script>
                ...
                isset($_POST['year_disco_modificado'])){
                    ...
                    if(preg_match('/\d/', $_POST['nombre_disco_modificado']) || !preg_match('/[0-9]/', $_POST['year_disco_modificado'])){
                        ...
                        $nuevo_nombre = $mysqli->real_escape_string($_POST['nombre_disco_modificado']);
                        $nuevo_year = $mysqli->real_escape_string($_POST['year_disco_modificado']);
                ...
                if(isset($_POST['cancion']) &&
                    isset($_POST['duracion'])){
                        ...
                        for ($i=0; $i < sizeof($_POST['cancion']) ; $i++) { 
                            $cancion = $mysqli->real_escape_string($_POST['cancion'][$i]);
                            $duracion = $mysqli->real_escape_string($_POST['duracion'][$i]);
            ...
            if(isset($_POST['nombre_concierto_modificado']) &&
                ...
                if(preg_match('/\d/', $_POST['nombre_concierto_modificado'])){
                    ...
                    $nuevo_nombre = $mysqli->real_escape_string($_POST['nombre_concierto_modificado']);
                    $nueva_fecha = $mysqli->real_escape_string($_POST['fecha_concierto_modificado']);
                    $nueva_hora = $mysqli->real_escape_string($_POST['hora_concierto_modificado']);
                    $nuevo_lugar = $mysqli->real_escape_string($_POST['lugar_concierto_modificado']);
                    $nueva_descripcion = $mysqli->real_escape_string($_POST['descripcion_concierto_modificada']);
            ...
            if(isset($_POST['nombre_componente_modificado']) &&
                ...
                if(preg_match('/\d/', $_POST['nombre_componente_modificado'])){
                    ...
                    $nuevo_nombre = $mysqli->real_escape_string($_POST['nombre_componente_modificado']);
                    $nueva_fecha = $mysqli->real_escape_string($_POST['fecha_componente_modificado']);
                    $nueva_descripcion = $mysqli->real_escape_string($_POST['bio_componente_modificada']);
            ...
            if(isset($_POST['borrarPer'])){
                ...
                if(isset($_POST['nombre_gest_mod'])&&
                    isset($_POST['apellidos_gest_mod'])&&
                    isset($_POST['fecha_gest_mod'])&&
                    isset($_POST['id_pedido_mod'])
                ){
                    
                    $id_pedido = $_POST['id_pedido_mod'];
                    $nombre_gestor = $_POST['nombre_gest_mod'];
                    $apellidos_gestor = $_POST['apellidos_gest_mod'];
                    $fecha_gestor = $_POST['fecha_gest_mod'];


                    echo '<form class="login_form" id="mod_pedido" action="modificar.php" method="POST">
                        <input type="hidden" name="id_prod_modificado" value="'.$id_pedido.'"> 
                        <h3><span class="color_azul">Cambiar a </span>'.
                        '<input type="hidden" name="nombre_gestor_modificado" value="'. $nombre_gestor .'">'.
                        '<input type="hidden" name="apellidos_gestor_modificado" value="'. $apellidos_gestor .'">'.
                        '<input type="hidden" name="fecha_gestor_modificado" value="'. $fecha_gestor .'">'.
                        'Aceptado <input type="radio" name="estado_mod" value="aceptado">'.
                        'Denegado <input type="radio" name="estado_mod" value="denegado"><br><br>';
                    echo 'Email a enviar <br><textarea rows="10" cols="50" name="email_modificado" form="mod_pedido"></textarea> <br> ';
                ...
                if(isset($_POST['estado_mod']) &&
                    isset($_POST['email_modificado'])){

                        // Guardo los datos del gestor en la base de datos ya que ha pinchado sobre modificar
                        $id = $mysqli->real_escape_string($_POST['id_prod_modificado']);
                        $nuevo_estado = $mysqli->real_escape_string($_POST['estado_mod']);
                        $nombre_gestor = $mysqli->real_escape_string($_POST['nombre_gestor_modificado']);
                        $apellidos_gestor = $mysqli->real_escape_string($_POST['apellidos_gestor_modificado']);
                        $fecha_gestor = $mysqli->real_escape_string($_POST['fecha_gestor_modificado']);
                        $email_enviar =  $mysqli->real_escape_string($_POST['email_modificado']);

                    $sql = "UPDATE `pedidos` SET `nombre_gest` = '$nombre_gestor', `apellidos_gest` = '$apellidos_gestor', `fecha_gest` = '$fecha_gestor', `estado` = '$nuevo_estado', `email_enviado` = '$email_enviar' WHERE `pedidos`.`id` = '$id'";
                    guardarLogs($sql);
                    $mysqli->query($sql) or die($mysqli->error);
                ...
                if(isset($_POST['disco_gestor_mod'])&&
                    isset($_POST['precio_gestor_mod'])
                ){
                    
                    $nombre = $_POST['disco_gestor_mod'];
                    $precio = $_POST['precio_gestor_mod'];



                    echo '<form class="login_form" action="modificar.php" method="POST">
                        <input type="hidden" name="disco_gestor_nombre" value="'.$nombre.'"> 
                        <h3><span class="color_azul">Actualizar precio del artículo </span>'.$nombre.'<br><br>'.
                        '<input type="text" name="disco_gestor_precio" value="' . $precio . '"> &euro;';
                ...
                if(isset($_POST['disco_gestor_nombre']) &&
                    isset($_POST['disco_gestor_precio'])){

                        
                        $nuevo_precio = $mysqli->real_escape_string($_POST['disco_gestor_precio']);
                        $nombre_disco = $mysqli->real_escape_string($_POST['disco_gestor_nombre']);
                        

                    $sql = "UPDATE `articulos` SET `precio` = '$nuevo_precio' WHERE `articulos`.`nombre` = '$nombre_disco'";
                    guardarLogs($sql);
                    $mysqli->query($sql) or die($mysqli->error);
            ...
            if(isset($_POST['copia'])){
                ...
                $sql = "SELECT * INTO OUTFILE '$usuarios' FROM `usuarios`";
                $mysqli->query($sql) or die($mysqli->error);


                echo '<script> alert("Backup hecho correctamente"); window.location = "gestion.php" </script>';
            }else if(isset($_POST['importar'])){
        
                
                
                echo '<script> alert("Importado correctamente"); window.location = "gestion.php" </script>';
            }else if(isset($_POST['borrar'])){

                echo '<script> alert("Borrado correctamente"); window.location = "gestion.php" </script>';
            }
